...
[Customizing Your Theme]: ../docs/user-guide/customizing-your-theme.md#using-the-theme-custom_dir
[custom_dir]: ../docs/user-guide/configuration.md#custom_dir
[name]: ../docs/user-guide/configuration.md#name
[docs_dir]: ../docs/user-guide/configuration.md#docs_dir
[configuration]: #theme-configuration
[packaged]: #packaging-themes
[theme]: ../docs/user-guide/configuration.md#theme
...
[blocks]: ../docs/user-guide/customizing-your-theme.md#overriding-template-blocks

### Picking up CSS and JavaScript from the config

MkDocs defines the top-level [extra_css](../docs/user-guide/configuration.md#extra_css) and [extra_javascript](../docs/user-guide/configuration.md#extra_javascript) configs. These are lists of files.
...
* [config.site_name](../docs/user-guide/configuration.md#site_name)
* [config.site_url](../docs/user-guide/configuration.md#site_url)
* [config.site_author](../docs/user-guide/configuration.md#site_author)
* [config.site_description](../docs/user-guide/configuration.md#site_description)
* [config.theme.locale](../docs/user-guide/configuration.md#locale) (See also [Theme Configuration](#locale) below)
* [config.extra_javascript](../docs/user-guide/configuration.md#extra_javascript)
* [config.extra_css](../docs/user-guide/configuration.md#extra_css)
* [config.repo_url](../docs/user-guide/configuration.md#repo_url)
* [config.repo_name](../docs/user-guide/configuration.md#repo_name)
* [config.copyright](../docs/user-guide/configuration.md#copyright)
...
[nav]: ../docs/user-guide/configuration.md#nav
...
[`extra`](../docs/user-guide/configuration.md#extra) configuration option. This is a
...
Convert an item from `extra_javascript` to a `<script>` tag that takes into account all [customizations of this config](../docs/user-guide/configuration.md#extra_javascript) and has the equivalent of [`|url`](#url) behavior built-in.
...
[site_dir]: ../docs/user-guide/configuration.md#site_dir
[prebuild_index]: ../docs/user-guide/configuration.md#prebuild_index
...
[localization/translation]: ../docs/user-guide/localizing-your-theme.md
