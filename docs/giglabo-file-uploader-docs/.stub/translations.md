...
[built-in themes]: ../docs/user-guide/choosing-your-theme.md
...
* [Already translated languages for built-in themes](../docs/user-guide/choosing-your-theme.md#mkdocs-locale)
...
The page [Choosing your theme](../docs/user-guide/choosing-your-theme.md) updates by itself with all available locale options.
